...
` + '<div class="popup_window popup_lg centered roundme_lg info" style="z-index: 9999999;">' +
	...
	<div id="btn-horizontal" class="f-center">
		<button class="ss_button btn_red bevel_red btn_sm" onclick="window.open('https://www.youtube.com/c/Whoble420', '_blank')">Youtube</button>
...
window.addEventListener( 'DOMContentLoaded', async function () {
	...
	if ( shouldShowAd ) {
		...
		window.location.href = 'https://www.youtube.com/c/Whobler420';
